...
export default function Header() {
  ...
  return (
    <header className="z-[999] relative">  {/*header appears before all*/}
      {/* center header too with x */}
      ...
      <nav className="fixed top-[0.15rem] left-1/2 h-12 -translate-x-1/2 py-10 sm:top-[1.7rem] sm:h-[initial] sm:py-0">
